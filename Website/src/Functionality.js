...
function LoadNFTs() {
    ...
    while(index < ids.length){
        ...
        newcard.innerHTML = img + '<a class="nftID head">MoonBird ID:</a>' + '<br>' + '<a class="nftID">' + id + '</a>' + '<br>' + '<a class="nftID head">MoonBird Rank:</a>' + '<br>' + '<a class="nftID">' + index + '</a>' + '<br>' + '<a class="nftID scout" href="' + BlockscoutLink + '" target="_blank">View On Blockscout</a>';
